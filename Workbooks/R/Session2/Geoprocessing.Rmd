...
Index and view!
```{r}
gages_SouthSantiam <- gages_sf[SouthSantiam$basin,]

mapview(gages_SouthSantiam, legend=FALSE) + mapview(SouthSantiam$basin, alpha.regions=.08, legend=FALSE)
```
